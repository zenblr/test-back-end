...
exports.addCustomer = async (req, res, next) => {
  ...
  let getMobileNumber = await models.registerCustomerOtp.findOne({
  ...
  let customerExist = await models.customers.findOne({
...
exports.registerCustomerSendOtp = async (req, res, next) => {
  ...
  await models.registerCustomerOtp.create({
    mobileNumber,
    otp,
    createdTime,
    expiryTime,
...
exports.verifyOtp = async (req, res, next) => {
  ...
  let verifyFlag = await models.registerCustomerOtp.update(
    { isVerified: true },
...
exports.editCustomer = async (req, res, next) => {
  ...
  let mobileNumberExist = await models.customers.findOne({
    where: { mobileNumber: mobileNumber },
  });
  ...
  await sequelize.transaction(async (t) => {
    const customer = await models.customers.update(
      {
        firstName,
        lastName,
        mobileNumber,
...
exports.filterCustomer = async (req, res) => {
  ...
  let customerFilterData = await models.customers.findAll({
    where: query,
    isActive: true,
  });
