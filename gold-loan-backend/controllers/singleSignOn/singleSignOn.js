            ...
            if (userData) {
                ...
                if (broker) {
                    ...
                    if (defaultFind.status) {
                        let permissions = defaultFind.permissions.filter(data => data.description == 'customerView' || data.description == 'orderView' || data.description == 'productView' || data.description == 'refundDetailsView' || data.description == 'refundDetailsEdit' || data.description == 'orderAdd')
