...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('karza_detail', [{
      ...
      panUrl: 'https://api.karza.in/v2/pan',
      pan_verify_url: 'https://api.karza.in/v2/pan-authentication',
      name_url: 'https://api.karza.in/v3/name',
      kyc_ocr_url: 'https://api.karza.in/v3/ocr/kyc',
      form_ocr_url: 'https://api.karza.in/v2/ocr/tds',
      dl_authentication_url: 'https://api.karza.in/v3/dl',
      voter_id_authentication_url: 'https://api.karza.in/v2/voter',
      passport_verification_url: 'https://api.karza.in/v3/passport-verification',
      key: 'eZyRyhFF6woCujs',
      consent: 'Y',
      type: 'individual',
      preset: 'L',
