...
const { customerLogin, verifyCustomerLoginOtp } = require('../controllers/auth/customerAuthController');
...
router.post('/verify-customer-login', wrapper(verifyCustomerLoginOtp));
