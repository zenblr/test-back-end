...
const { loanTransferBasicDeatils,customerDetails,loanTransferDocuments,loanTransferBmRating,loanTransferDisbursal,getSingleLoanDetails,getLoanTransferList } =require('../controllers/customerLoanTransfer/customerLoanTransfer'); // IMPORTING LOAN PROCESS FUNCTIONS
