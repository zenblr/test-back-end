...
const { applyLoanTransferFromApp } = require('../controllers/customerLoanTransfer/customerLoanTransferForApp')
...
//for apprasier app
route.post('/loan-transfer-request', checkAuth, wrapper(applyLoanTransferFromApp))
