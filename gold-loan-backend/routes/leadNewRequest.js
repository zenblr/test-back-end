...
route.post('/', checkAuth,addleadNewRequestValidation,validatiError, wrapper(addLeadNewRequest)); // add new request

route.put('/assign-appraiser/:id', checkAuth, wrapper(assignAppraiser)); // ASSIGN APPRAISER

route.put('/:id', checkAuth,updateleadNewRequestValidation,validatiError, wrapper(updateLeadNewRequest)); // update new request
