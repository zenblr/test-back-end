...
const { addPartnerBranchUser, updatePartnerBranchUser, readPartnerBranchUser, readPartnerBranchUserById, deactivatePartnerBranchUser, getBranchByPartnerId, sendOtp, verifyOtp } = require('../controllers/partnerBranchUser/partnerBranchUser');
