module.exports = {
    FULL_RELEASE_PAYMENT_CASH: "Full release payment by cash",
    FULL_RELEASE_PAYMENT_CHEQUE: "Full release payment by cheque",
    ...
    FULL_RELEASE_AMOUNT_STATUS_P:"Amount status changed to rejected",
